...
% jangada: windowsize 5 (as in paper), epochs: 40
...
\begin{figure}
	% jan, zeb, fea
	% acc5: 44,48,40 | wacc5: 92,96,88 | acc2: 43,47,39, wacc2: 91,95,87
	...
	\begin{subfigure}[t]{0.5\textwidth}
		...
		mark options={solid,scale=0.7},legend style={at={(0.99,0.99)},anchor=north east},
